...
//     if (!file) return;
//     handelAnalyze({ companyName, jobTitle, jobDescription, file });
//     return (
...
//               </>
//             ) : (
//               <h2>Dorp Your resume for an Ats score and improvement tips</h2>
//             )}
//             {!isProcessing && (
//               <form
//                 id="upload-form"
...
//                     <FileUp onFileSelect={handleFileSelect} />
//                   </div>
//                 </div>
